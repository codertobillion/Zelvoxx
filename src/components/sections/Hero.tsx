  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center overflow-hidden pt-24 md:pt-32 pb-10">
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        <motion.div
          animate={{ x: [0, 20, 0], y: [0, -16, 0], opacity: [0.2, 0.35, 0.2] }}
          transition={{ duration: 14, repeat: Infinity, ease: "easeInOut" }}
          className="absolute inset-0 bg-[radial-gradient(circle_at_70%_25%,rgba(123,97,255,0.2),transparent_45%),radial-gradient(circle_at_20%_70%,rgba(45,156,219,0.16),transparent_45%)]"
        />
