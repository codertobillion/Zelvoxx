...
export default function SystemFlow() {
  return (
    <section id="system" className="relative overflow-hidden bg-[#11131d] border-y border-white/10 py-32 md:py-44">
      {/* Background Glow */}
      ...
      <div className="max-w-[90rem] mx-auto px-6 lg:px-10 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_2fr] gap-20 lg:gap-28 items-center">
          ...
          <div className="space-y-6">
            ...
            <motion.h2 
              ...
              className="text-4xl md:text-6xl lg:text-7xl font-heading font-black text-white leading-[1.05] tracking-tight"
            >
          ...
          {/* Right Column: Flow */}
          <div className="relative w-full overflow-x-auto pb-10 scrollbar-hide glass-premium premium-border soft-glow rounded-[2rem] p-10 md:p-14">
            <div className="min-w-[760px] flex justify-between items-center relative">
              ...
              <motion.div
                className="absolute top-1/2 left-0 -translate-y-1/2 w-4 h-4 rounded-full bg-primary shadow-[0_0_20px_rgba(123,97,255,0.9)] z-20"
              ...
              <motion.div
                ...
                initial={{ x: 0, opacity: 0 }}
                whileInView={{ x: [0, 700], opacity: [0, 1, 0] }}
                viewport={{ once: false }}
                transition={{ duration: 3.3, repeat: Infinity, ease: "easeInOut", delay: 1.1 }}
              />

              <motion.div
                className="absolute top-1/2 left-0 h-[2px] w-32 -translate-y-1/2 bg-gradient-to-r from-transparent via-white to-transparent opacity-70 blur-[1px]"
                initial={{ x: -80, opacity: 0 }}
                whileInView={{ x: [0, 700], opacity: [0, 0.9, 0] }}
                viewport={{ once: false }}
              ...
              {steps.map((step, idx) => (
                <div key={idx} className="flex flex-col items-center group relative z-10">
                  ...
                  <motion.h3 
                    ...
                    className="text-sm md:text-base font-bold font-heading text-white tracking-wide mt-4 absolute -bottom-8 whitespace-nowrap"
                  >
                    {step.title}
                  </motion.h3>
                </div>
